...
echo "Some output"; // ข้อมูลนี้จะส่งออกไปแล้ว
// ดึงข้อมูลผู้ใช้
$adminId = $_SESSION['admin_id'];
$stmt = $pdo->prepare("SELECT username FROM admin WHERE id = :id");
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Pet sitting<sup></sup></div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="add_Admin.php">เพิ่มผู้ดูแลระบบ</a>
